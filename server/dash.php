...
function makeHls($sourceVideoPath) {
	...
	echo shell_exec("/usr/local/bin/convert.sh ".$sourceVideoPath." 3072 ".$fps." ".$width."x".$height." 44100 128 ".$videoResultPath.DIRECTORY_SEPARATOR.$videoName."_original.ts");
	echo shell_exec("/usr/local/bin/convert.sh ".$sourceVideoPath." 3072 ".$fps." ".$width."x".$height." 44100 128 ".$videoResultPath.DIRECTORY_SEPARATOR.$videoName."_original.mp4");


	echo shell_exec("/usr/local/bin/convert.sh ".$sourceVideoPath." 768 ".$fps." ".($width / 2)."x".($height / 2)." 44100 128 ".$videoResultPath.DIRECTORY_SEPARATOR.$videoName."_half.ts");
	echo shell_exec("/usr/local/bin/convert.sh ".$sourceVideoPath." 768 ".$fps." ".($width / 2)."x".($height / 2)." 44100 128 ".$videoResultPath.DIRECTORY_SEPARATOR.$videoName."_half.mp4");
	echo shell_exec("/usr/local/bin/convert.sh ".$sourceVideoPath." 200 ".$fps." ".($width / 4)."x".($height / 4)." 44100 128 ".$videoResultPath.DIRECTORY_SEPARATOR.$videoName."_quarter.ts");
	echo shell_exec("/usr/local/bin/convert.sh ".$sourceVideoPath." 200 ".$fps." ".($width / 4)."x".($height / 4)." 44100 128 ".$videoResultPath.DIRECTORY_SEPARATOR.$videoName."_quarter.mp4");
